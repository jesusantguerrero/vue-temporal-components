<template>
  ...
  >
    <div class="text-md" :class="[trackerMode.color, trackerMode.colorBorder]">
      {{ trackerMode.text }}
    </div>
    ...
    <div class="flex items-center">
      ...
      >
        ...
        <i
          class="fas"
          :class="[trackerIcon, state.isMini ? 'mr-2' : 'text-3xl']"
        ></i>
      </div>
      <button
        v-if="!state.isMini"
